...
export default function SignUp() {
  ...
  const { call: sendAuthLink, loading: sendAuthLinkLoading, error: sendAuthLinkError,
  result: sendAuthLinkResult, reset: resetSendAuthLink } = useFrappePostCall('wecars.auth.send_auth_link');
  const { call: verifyToken, loading: verifyTokenLoading, error: verifyTokenError, 
  result: verifyTokenResult, reset: resetVerifyToken } = useFrappePostCall('wecars.auth.verify_token');
